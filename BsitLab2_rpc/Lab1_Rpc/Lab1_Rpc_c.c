...
handle_t hLab1_rpcHandle;


static const RPC_CLIENT_INTERFACE Lab1_Rpc___RpcClientInterface =
    {
...
RPC_IF_HANDLE Lab1_Rpc_v1_0_c_ifspec = (RPC_IF_HANDLE)& Lab1_Rpc___RpcClientInterface;

extern const MIDL_STUB_DESC Lab1_Rpc_StubDesc;

static RPC_BINDING_HANDLE Lab1_Rpc__MIDL_AutoBindHandle;
    ...
    /* [string][in] */ char *domain)
{
    ...
    _RetVal = NdrClientCall2(
                  ( PMIDL_STUB_DESC  )&Lab1_Rpc_StubDesc,
                  (PFORMAT_STRING) &Lab1_Rpc__MIDL_ProcFormatString.Format[0],
                  ( unsigned char * )&login);
    ...
    /* [out] */ char data[ 1024 ])
{
    ...
    _RetVal = NdrClientCall2(
                  ( PMIDL_STUB_DESC  )&Lab1_Rpc_StubDesc,
                  (PFORMAT_STRING) &Lab1_Rpc__MIDL_ProcFormatString.Format[48],
    ...
    /* [in] */ long count)
{
    ...
    _RetVal = NdrClientCall2(
                  ( PMIDL_STUB_DESC  )&Lab1_Rpc_StubDesc,
                  (PFORMAT_STRING) &Lab1_Rpc__MIDL_ProcFormatString.Format[96],
                  ( unsigned char * )&filename);
    return ( int  )_RetVal.Simple;
    ...
    /* [string][in] */ char *filename)
{
    ...
    _RetVal = NdrClientCall2(
                  ( PMIDL_STUB_DESC  )&Lab1_Rpc_StubDesc,
                  (PFORMAT_STRING) &Lab1_Rpc__MIDL_ProcFormatString.Format[144],
                  ( unsigned char * )&filename);
    return ( int  )_RetVal.Simple;
    ...
    /* [string][in] */ char *filename)
{
    ...
    _RetVal = NdrClientCall2(
                  ( PMIDL_STUB_DESC  )&Lab1_Rpc_StubDesc,
                  (PFORMAT_STRING) &Lab1_Rpc__MIDL_ProcFormatString.Format[180],
                  ( unsigned char * )&filename);
    return ( int  )_RetVal.Simple;
...
static const MIDL_STUB_DESC Lab1_Rpc_StubDesc = 
    {
    (void *)& Lab1_Rpc___RpcClientInterface,
    MIDL_user_allocate,
    MIDL_user_free,
    &hLab1_rpcHandle,
    0,
